...
public class HSH_PatternAvoider2 : Agent
{
    ...
    public GameObject fbt;  //fire ball thrower를 제어
    ...
    public void Damaged(float dmg)
    {
        hp -= dmg;
        AddReward(dmg * (-0.05f));
        fbt.GetComponent<HSH_FireBallThrower>().AddReward(0.1f);    //데미지를 받으면 SpellField Generator에게 보상
